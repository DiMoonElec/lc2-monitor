...
{
  public class DataElementUInt : DataElementBase
  {
    private uint _value;
    ...
    public DataElementUInt(string name, int address)
        : base(name, "uint", address, Sizeof)
    {
      _value = 0;
    }
    ...
    public override void SetValue(string value)
    {
      ...
      {
        throw new ArgumentException($"Invalid value.  Valid range is {uint.MinValue}..{uint.MaxValue}.");
      }
